...
# - selezionare i cbg del fiume è un casino, dovremmo metterceli a cercare controllare tipo uno ad uno
# - stavo pensando a idea casuale di fare un classificatore, che riconosce fiumi non fiumi usando come data intanto questi ma bah a che serve
# - cosa facciamo? li vogliamo togliere?
#https://www2.census.gov/geo/maps/dc10map/tract/st36_ny/c36061_new_york/DC10CT_C36061_001.pdf
# https://www1.nyc.gov/assets/planning/download/pdf/about/publications/maps/mn-census-tracts-map-rotated.pdf  FORSE QUESTO AIUTA
# in generale 36 0610 fissi + 3 cifre della zona del sito sopra + 3 cifre ulteriori