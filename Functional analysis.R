...
points(pca_W.1$scores[c(7,14,21,28),1],pca_W.1$scores[c(7,14,21,28),2],col=2, lwd=4)
...
lines(stops[,871],lwd=4, col=3) 
lines(stops[,267],lwd=4, col=4) 
...
plot(pca_W.1$scores[,1],pca_W.1$scores[,2],xlab="Scores FPC1",ylab="Scores FPC2",lwd=2)
points(pca_W.1$scores[c(7,14,21,28),1],pca_W.1$scores[c(7,14,21,28),2],col=2, lwd=4)
points(pca_W.1$scores[c(1,8,15,22,29),1],pca_W.1$scores[c(1,8,15,22,29),2],col=3, lwd=4)
